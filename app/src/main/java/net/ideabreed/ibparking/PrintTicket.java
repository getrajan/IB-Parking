...
public class PrintTicket{
    ...
    private static final String TAG = PrintTicket.class.getSimpleName();
    ...
    public PrintTicket(Context context, PosApi api) {
        this.mApi = api;
    ...
    public void addText(int concentration, byte[] textData) {
        Log.d("Print Queue addText",textData.toString());
        ...
        mSendList.add(mData);
        Log.d("addText",String.valueOf(mSendList));
    }
    ...
    public void addBmp(int concentration, int left, int width, int height, byte[] bmpData) {
        ...
        mSendList.add(mData);
        Log.d("addBmp", String.valueOf(mSendList));
    }
    ...
    public void printStart() {
        mSendHandler.sendEmptyMessage(11);
//        mSendHandler.obtainMessage();
    }
